...
class AdminApplicantController extends Controller
{
    ...
    function datatables()
    {
        $data = DB::table('applicant_fields as af')
            ->select('ad.id','ad.user_id','ad.name','ad.gender','ad.pob','ad.dob','ad.last_edu','ad.major','ad.grad_year','ad.file', 'u.phone', 'u.email')
        ...
        $data = $data->groupBy('ad.id','ad.user_id','ad.name','ad.gender','ad.pob','ad.dob','ad.last_edu','ad.major','ad.grad_year','ad.file','u.phone','u.email');
